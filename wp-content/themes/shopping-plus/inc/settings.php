...
if( !function_exists('ecommerce_star_settings') ){
		...
		function ecommerce_star_settings(){
			...
			'header_myaccount_text' => esc_html__('My Account', 'shopping-plus'),
			...
			'slider_speed' => 3000,
			'slider_button_text' => esc_html__('More Details', 'shopping-plus'),
			'slider_button_link' => '',
			...
			'menu_bar_color' => 'rgba(28,28,28,0.75)',
			'menu_text_color' => '#fff',
			...
			'footer_section_background_color' => '#7b1504',
